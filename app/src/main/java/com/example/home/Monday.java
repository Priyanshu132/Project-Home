...
//                .child(id).child("MessTimeTable").child("Monday");
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                switch (direction) {
                    ...
                    case ItemTouchHelper.RIGHT:
                        ...
                        databaseReference= FirebaseDatabase.getInstance().getReference().child("Owner's")
                                  .child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("MessTimeTable").child("Monday").child("Morning");
                ...
                if(id.equals(FirebaseAuth.getInstance().getCurrentUser().getUid())) {
                    ...
                    feedBack.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            builder.setTitle("Feedback For Monday");
